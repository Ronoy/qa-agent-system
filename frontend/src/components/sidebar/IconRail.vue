...
const IconKnowledge = defineComponent({ render: () => h('svg', { viewBox:'0 0 24 24', fill:'none', width:18, height:18 }, [
  h('path', { d:'M4 19.5A2.5 2.5 0 016.5 17H20', stroke:'currentColor', 'stroke-width':'1.8', 'stroke-linecap':'round' }),
  h('path', { d:'M6.5 2H20v20H6.5A2.5 2.5 0 014 19.5v-15A2.5 2.5 0 016.5 2z', stroke:'currentColor', 'stroke-width':'1.8' })
]) })

const navItems = [
  { key: 'chat', label: '对话', icon: IconChat },
  { key: 'knowledge', label: '知识库', icon: IconKnowledge },
